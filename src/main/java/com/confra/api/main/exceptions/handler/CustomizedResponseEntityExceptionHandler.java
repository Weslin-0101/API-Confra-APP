...
public class CustomizedResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(NotAllowedDuplicateValueException.class)
    public final ResponseEntity<ExceptionResponse> handleBadRequestDuplicateValueExceptions(
            Exception ex, WebRequest request
    ) {
        ExceptionResponse exceptionResponse = new ExceptionResponse(
                new Date(),
    ...
    public final ResponseEntity<ExceptionResponse> handleRequestNotAllowedExceptions(
            Exception ex, WebRequest request
    ) {
        ExceptionResponse exceptionResponse = new ExceptionResponse(
                new Date(),
